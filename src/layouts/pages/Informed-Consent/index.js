                      ...
                      {activeStep === 0 && (
                        <div>
                          <SoftBox>
                            ...
                            <p style={{ wordBreak: "break-all",marginBottom:"-28px",textAlign : "justify" }} className="initialhere
">
                              ...
                              <p className="clientInitialName">Client should initial here.&nbsp;</p><Grid item xs={8} sm={4} lg={3} mb={2}  className="setInitalName">
                                <FormField
                      ...
                      {activeStep === 1 && (
                        <div>
                          <SoftBox>
                            ...
                            <p style={{ wordBreak: "break-all",marginBottom:"-28px",textAlign : "justify" }} className="initialhere1" >
                              ...
                              photos (excluding face shots) being used for education, research and
